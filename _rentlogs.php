                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Show Rent Detailed Payments</h4>
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="#">Admin</a>
                                        </li>
                                        <li>
                                            <a href="#">Other Payments</a>
                                        </li>
                                        <li class="active">
                                            Show Payments
                                        </li>
                                    ...
                                    <div class="demo-box m-t-20">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $query = mysqli_query($con, "SELECT `Rname`, `Pid`, `date`, `Value`, `PaidMonths`, `reciever` FROM `payments` WHERE 1");
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo htmlentities($row['PaidMonths']); ?></td>
                                                            <td><?php echo htmlentities($row['reciever']); ?></td>
